 ...
 * 创建 React Element
 * type      元素类型
 * config    配置属性(包含了props属性，还有一些react特殊使用的属性)
 * children  子元素
 * 1. 属性分离：分离 props 属性和特殊属性
 * 2. children：将子元素挂载到 props.children 中
 * 3. 默认props：为 props 属性赋默认值 (defaultProps)
 * 4. 返回React元素：创建并返回 ReactElement
 */
